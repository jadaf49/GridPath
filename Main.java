public class Main
{
   public static void main(String[]args)
   {
       ...
       System.out.println(two.sumPath(0,0));//should print 42
       System.out.println(two.getNextLoc(1,4)); //should print location of 0
       System.out.println(two.sumPath(1,4));//should print 44
